...
public class ExposureDeltaTransformer implements ValueTransformerWithKey<String, Position, Iterable<ExposureDelta>> {
    ...
    private ReadOnlyKeyValueStore<String, ValueAndTimestamp<InstrumentRefData>> refdataStore;
    ...
    public void init(ProcessorContext context) {
        ...
        this.refdataStore = (ReadOnlyKeyValueStore<String, ValueAndTimestamp<InstrumentRefData>>) context.getStateStore(refdataStoreName);
    }
    ...
    public Iterable<ExposureDelta> transform(String key, Position value) {
        ...
        ValueAndTimestamp<InstrumentRefData> stamped = refdataStore.get(value.instrumentId());
        InstrumentRefData refdata = stamped == null ? null : stamped.value();
